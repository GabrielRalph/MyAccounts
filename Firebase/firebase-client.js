...
import {
        ...
        onAuthStateChanged, 
        sendEmailVerification as _sendEmailVerification} from 'https://www.gstatic.com/firebasejs/12.7.0/firebase-auth.js'
...
import {
        ...
        orderByChild, 
        limitToFirst, 
        limitToLast } from 'https://www.gstatic.com/firebasejs/12.7.0/firebase-database.js'

import { getFunctions, 
         httpsCallable  } from 'https://www.gstatic.com/firebasejs/12.7.0/firebase-functions.js'
...
import { getStorage, 
         ...
         getDownloadURL, 
         getBlob, 
         getMetadata } from 'https://www.gstatic.com/firebasejs/12.7.0/firebase-storage.js'
